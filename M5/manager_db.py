...
class ClientesDb(object):
	...
	def inserir_com_lista(self):
		...
		try:
			...
			""",lista)
			self.db.commit_db()
			print("Dados inseridos da lista com sucesso: % registros." % len(lista))
	...
	def deletar(self, id):
		try:
			...
			if c:
				...
				print('Não existe cliente com o códio informado.')
		except e:
			raise e
	...
	def backup(self, file_name='sql/clientes_bkrp.sql'):
